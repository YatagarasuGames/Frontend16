$('#body-wrapper').load('./base/about-me.html');
$('#page-style').attr('href', '../styles/style_about-me_page.css'); 
...
$('#first-semester').on('click', function() {
    $('#body-wrapper').load('./base/first-semester.html');
    $('#page-style').attr('href', '../styles/style_first-semester_page.css');
    removeNavClass();
    $(this).toggleClass('nav-clicked');
});

$('#projects').on('click', function() {
    $('#body-wrapper').load('./base/projects.html');
    $('#page-style').attr('href', '../styles/style_projects_page.css');
    removeNavClass();
    $(this).toggleClass('nav-clicked');
});
